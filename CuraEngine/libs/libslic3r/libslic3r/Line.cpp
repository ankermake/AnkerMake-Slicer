...
{
	Vec2d x0clip, x1clip;
	bool result = Geometry::liang_barsky_line_clipping<double>(this->a.cast<double>(), this->b.cast<double>(), BoundingBoxf(bbox.bmin.cast<double>(), bbox.bmax.cast<double>()), x0clip, x1clip);
	if (result) {
