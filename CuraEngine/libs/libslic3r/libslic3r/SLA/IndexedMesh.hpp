...
public:
    ...
    explicit IndexedMesh(const TriangleMesh&, ccglobal::Tracer* tracer = nullptr);
    explicit IndexedMesh(const TriangleMesh& tmesh, const IndexedMesh& other);
