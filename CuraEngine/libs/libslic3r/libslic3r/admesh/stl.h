...
struct stl_file {
    ...
    void clone(const stl_file& sf) {
        facet_start = sf.facet_start;
        neighbors_start = sf.neighbors_start;
        stats = sf.stats;
    }
...
struct indexed_triangle_set
{
    ...
    void clone(const indexed_triangle_set& its)
    {
        indices = its.indices;
        vertices = its.vertices;
    }
...
extern void stl_check_facets_exact(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
extern void stl_check_facets_nearby(stl_file *stl, float tolerance, ccglobal::Tracer* tracer = nullptr);
extern void stl_remove_unconnected_facets(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
...
extern void stl_verify_neighbors(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
extern void stl_fill_holes(stl_file *stl);
extern bool stl_fix_normal_directions(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
extern void stl_fix_normal_values(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
extern void stl_reverse_all_facets(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
...
extern void stl_get_size(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
...
extern void stl_generate_shared_vertices(stl_file *stl, indexed_triangle_set &its, ccglobal::Tracer* tracer = nullptr);
...
extern void stl_calculate_volume(stl_file *stl, ccglobal::Tracer* tracer = nullptr);
