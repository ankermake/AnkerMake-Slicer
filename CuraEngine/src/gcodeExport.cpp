...
void GCodeExportBase::writeJerkXYZE(char axis, const Velocity &jerk)
{
    switch (axis) {
    case 'X':
    case 'Y':
        ...
        break;
    case 'Z':
        *output_stream << "M205 Z" << PrecisionedDouble{2, jerk} << new_line;
        break;
    case 'E':
        *output_stream << "M205 E" << PrecisionedDouble{2, jerk} << new_line;
        break;
    default:
        break;
    }
