#include "SupportTrapezoidBody.h"

//SupportTrapezoidBody::SupportTrapezoidBody()
//{
...
bool SupportTrapezoidBody::create(QVector3D topcenter, QVector3D downcenter, float toplenth, float topwide, float downlenth, float downwide)
{
