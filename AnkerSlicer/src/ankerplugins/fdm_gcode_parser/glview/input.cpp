...
{
    return std::find(
        sg_buttonInstances.begin(),
        sg_buttonInstances.end(),
        value);
}
...
void Input::registerKeyPress(int key)
{
    ...
    {
        sg_keyInstances.push_back(
            KeyInstance((Qt::Key)key, InputRegistered));
    }
}
...
void Input::registerMousePress(Qt::MouseButton button)
{
    ...
    {
        sg_buttonInstances.push_back(
            ButtonInstance(button, InputRegistered));
    }
}
