...
public:
    ...
    public:
        ...
        bool  has(Anker::Axis axis) const { return (m_mask & (1 << int(axis))) != 0; }
        float value(Anker::Axis axis) const { return m_axis[axis]; }
        ...
        void set(const GCodeReader &reader, const Anker::Axis axis, const float new_value, const int decimal_digits = 3);
