...
FdmQml_Root{ id:fdmextruder_def_json; objectName: "qrc:/Settings/FdmJsonObjTree_All.qml"
    ...
    FdmQml_Settings{ id:settings; objectName: "settings"
        FdmQml_Category{ id:anker_fdm_setting; objectName: "anker_fdm_setting"
            ...
            FdmQml_Param{ id:param_print_mode; objectName: "param_print_mode"
                fdmLabel: "Print Mode"
                fdmDescription: "Print Mode for speedy,normal or fine"
                fdmType: "enum"
                fdmOptions:{
                    "normal": "Normal Print",
                    "fast": "Fast Print",
                    "fine": "Fine Mode for Print"
                }
            ...
            FdmQml_Param{ id:index_of_role_order_in_part; objectName: "index_of_role_order_in_part"
                fdmLabel: "Role Order In Part"
                fdmDescription: "Printing order for [inner wall(s), outer wall, infill] of part"
                fdmDefaultValue: "E_Order_Nothing"
                fdmType: "enum"
                fdmOptions:{
                    "0" : "Order_Nothing"           ,
                    "1" : "Infill->Outer->Inner",
                    "2" : "Infill->Inner->Outer",
                    "3" : "Outer->Inner->Infill",
                    "4" : "Inner->Outer->Infill",
                    "5" : "Inner->Infill->Outer",
                    "6" : "Outer->Infill->Inner",
                }
                fdmSettablePerMesh: true
                fdmSettablePerExtruder: false
                fdmSettablePerMeshgroup: false
            ...
            FdmQml_Param{ id:optimize_wall_0_printing_order; objectName: "optimize_wall_0_printing_order"
                ...
                fdmDefaultValue: false
                fdmSettablePerMesh: true
                fdmAffectedById: "index_of_role_order_in_part"
            }
    ...
    FdmQml_Category{ id:resolution; objectName: "resolution"
        ...
        FdmQml_Param{ id:layer_height_0; objectName: "layer_height_0"
            ...
            fdmUnit: "mm"
            fdmType: "float"
            fdmValue: Number(layer_height.fdmValue * 0.8 > 0.1 ? layer_height.fdmValue * 0.8 : 0.1)
            fdmDefaultValue: 0.3
    ...
    FdmQml_Category{ id:speed; objectName: "speed"
        ...
        fdmType: "category"
        fdmMinimumValue: 0.1
        fdmMaximumValue: 500 //Math.sqrt(machine_max_feedrate_x.fdmValue ** 2 + machine_max_feedrate_y.fdmValue ** 2)
        fdmMaximumValueWarning: 400 //1200.0 // 20x
        ...
        FdmQml_Param{ id:acceleration_enabled; objectName: "acceleration_enabled"
            ...
            FdmQml_Param{ id:acceleration_travel; objectName: "acceleration_travel"
                ...
                fdmMinimumValue: 0.1
                fdmMinimumValueWarning: 100.0
                fdmMaximumValueWarning: 5000 //99999.0
        ...
        FdmQml_Param{ id:jerk_enabled; objectName: "jerk_enabled"
            ...
            FdmQml_Param{ id:ak_VAJK_J_E_enabled; objectName: "ak_VAJK_J_E_enabled"
                fdmLabel: "Jerk E"
                fdmDescription: "Jerk is the maximum change in velocity (in mm/sec) that can occur instantaneously. It can also be thought of as the minimum change in velocity that will be done as an accelerated (not instantaneous) move."
                fdmDefaultValue: false
                fdmType: "bool"
                fdmAffectedById: ""
                FdmQml_Param{ id:ak_J_E_print; objectName: "ak_J_E_print"
                    fdmLabel: "Print Jerk E"
                    fdmDescription: "Print Jerk E"
                    fdmDefaultValue: 3.0
                    fdmType: "float"
                    fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                    fdmAffectedById: ""
                    FdmQml_Param{ id:ak_J_E_infill; objectName: "ak_J_E_infill"
                        fdmLabel: "Infill"
                        fdmDescription: "Infill Jerk"
                        fdmDefaultValue: 3.0
                        fdmValue: Number(ak_J_E_print.fdmValue)
                        fdmType: "float"
                        fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                        fdmAffectedById: "ak_J_E_print"
                    }
                    FdmQml_Param{ id:ak_J_E_wall; objectName: "ak_J_E_wall"
                        fdmLabel: "Wall"
                        fdmDescription: "Wall Jerk"
                        fdmDefaultValue: 3.0
                        fdmValue: Number(ak_J_E_print.fdmValue)
                        fdmType: "float"
                        fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                        ...
                        FdmQml_Param{ id:ak_J_E_wall_0; objectName: "ak_J_E_wall_0"
                            fdmLabel: "Outer Wall"
                            fdmDescription: "Outer Wall Jerk"
                            fdmDefaultValue: 3.0
                            fdmValue: Number(ak_J_E_wall.fdmValue)
                            fdmType: "float"
                            fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                            fdmAffectedById: "ak_J_E_wall"
                        }
                        FdmQml_Param{ id:ak_J_E_wall_x; objectName: "ak_J_E_wall_x"
                            fdmLabel: "Inner Wall"
                            fdmDescription: "Inner Wall Jerk"
                            fdmDefaultValue: 3.0
                            fdmValue: Number(ak_J_E_wall.fdmValue)
                            fdmType: "float"
                            fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                    ...
                    FdmQml_Param{ id:ak_J_E_topbottom; objectName: "ak_J_E_topbottom"
                        fdmLabel: "Skin"
                        fdmDescription: "Top & Bottom Skin Jerk"
                        fdmDefaultValue: 3.0
                        fdmValue: Number(ak_J_E_print.fdmValue)
                        fdmType: "float"
                        fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                    ...
                    FdmQml_Param{ id:ak_J_E_skirt_brim; objectName: "ak_J_E_skirt_brim"
                        fdmLabel: "Skirts & Brims"
                        fdmDescription: "Skirts & Brims Jerk"
                        fdmDefaultValue: 3.0
                        fdmValue: Number(ak_J_E_print.fdmValue)
                        fdmType: "float"
                        fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
                    ...
                    FdmQml_Param{ id:ak_J_E_layer_0; objectName: "ak_J_E_layer_0"
                        fdmLabel: "Initial Layer"
                        fdmDescription: "Initial Layer Jerk"
                        fdmDefaultValue: 3.0
                        fdmValue: Number(ak_J_E_print.fdmValue)
                        fdmType: "float"
                        fdmEnabled: ak_VAJK_J_E_enabled.fdmValue
    ...
    FdmQml_Category{ id:platform_adhesion; objectName: "platform_adhesion"
        ...
        FdmQml_Param{ id:min_contact_area; objectName: "min_contact_area"
            fdmLabel: "Minimum contact area"
            fdmDescription: "When the contact area between the printing region and the build platform is smaller than this minimum area, it will trigger the addition of a brim around the printing region. This increases the contact area between the printed object and the build platform, thereby improving the success rate of the printing process."
            fdmUnit: "mm²"
            fdmType: "float"
            fdmDefaultValue: 25.0
            fdmMinimumValue: 0.0
            fdmEnabled: adhesion_type.fdmValue === "autobrim"
            fdmSettablePerMesh: true
            fdmSettablePerExtruder: true
            fdmLimitToExtruder: Number(adhesion_extruder_nr.fdmValue)
            fdmAffectedById: "adhesion_extruder_nr"
